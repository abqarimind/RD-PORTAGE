  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[#ECEEF3] bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-page items-center justify-between px-4 py-3">
        ...
        <a
          href="#diagnostic"
          className="inline-flex min-h-[44px] items-center rounded-full bg-[#0B0D12] px-5 py-2.5 text-sm font-bold text-white transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-lg"
        >
...
function HeroFlash({ angle }: { angle: Angle }) {
  ...
  return (
    <section className="mx-auto max-w-page px-4 pb-section pt-8 md:pt-section-md">
      ...
      <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
        <div className="text-center lg:text-left">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2 text-xs font-semibold text-[#7A8093] lg:justify-start">
  ...
  return (
    <section className="mx-auto max-w-page px-4 pb-section">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        {chips.map(([big, small]) => (
          <div key={small} className="rounded-2xl border border-[#ECEEF3] bg-white px-4 py-4 text-center lg:text-left">
